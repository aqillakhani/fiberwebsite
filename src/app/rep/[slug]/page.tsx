...
import RepComparisonSection from "@/components/rep/rep-comparison-section"
import RepFaqSection from "@/components/rep/rep-faq-section"
import RepReviewsSection from "@/components/rep/rep-reviews-section"
...
export default async function RepProfilePage({ params, searchParams }: RepProfilePageProps) {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* ── 2. WHY FIBER — Education ── */}
      <RepComparisonSection />
