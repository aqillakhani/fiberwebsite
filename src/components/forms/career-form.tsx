    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div>
        <textarea
          ...
          rows={4}
          className="w-full px-4 py-3 rounded-lg border border-border bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-fiber-blue focus:border-transparent text-base resize-none"
        />
      ...
      <Button
        ...
        size="lg"
        className="w-full flex items-center justify-center gap-2 bg-fiber-blue hover:bg-fiber-blue/90 text-white min-h-[52px] text-base font-semibold glow-blue"
      >
        {isSubmitting ? (
          <>
