          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <input
                ...
                autoComplete="name"
                className="w-full h-12 md:h-12 px-4 rounded-lg bg-muted bg-card border border-border  text-foreground placeholder:text-muted-foreground  focus:outline-none focus:ring-2 focus:ring-fiber-red focus:border-transparent text-base"
              />
              {errors.fullName && (
