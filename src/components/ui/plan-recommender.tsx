  ...
  if (recommendedPlan) {
    return (
      <div className="text-center">
        ...
        <p className="text-3xl font-bold text-fiber-blue mb-2">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        {currentQuestion.options.map((option) => (
          <button
            ...
            className="inline-flex items-center justify-center h-12 px-6 rounded-lg border border-border text-foreground font-medium hover:bg-accent hover:border-fiber-blue/50 transition-all"
          >
            {option.label}
          </button>
        ))}
