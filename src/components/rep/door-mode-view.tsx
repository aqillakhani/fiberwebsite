      ...
      <div className="min-h-screen bg-background">
        ...
        <header className="border-b border-border px-4 py-3">
          <Link href="/" className="text-lg font-bold text-foreground">
            Fiber<span className="text-fiber-orange">Fast</span>USA
          </Link>
        </header>
      ...
      <main className="mx-auto max-w-lg px-4 py-6 space-y-6">
        ...
        <div className="flex items-center gap-4">
          {rep.photo_url ? (
            ...
            <div className="size-14 rounded-full bg-gradient-to-br from-fiber-blue/30 via-fiber-orange/20 to-fiber-blue/30 flex items-center justify-center flex-shrink-0">
